...
<head>
    ...
    <title>Cetak Data Pelanggaran Siswa Kelas</title>
...
<body>
    <h4 class="text-center font-weight-bold" style="font-size: 18px;">Data Pelanggaran Siswa Kelas {{ $item->jenjang }} {{ $item->kelas }}</h4>
