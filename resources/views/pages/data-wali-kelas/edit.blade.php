...
@section('title', 'Data Wali Kelas - Ubah')
...
<div class="row">
    <div class="col-lg-12 d-flex align-items-strech">
        <div class="card w-100">
            <div class="card-body">
                <h5 class="card-title fw-semibold">Ubah Data Wali Kelas</h5>
                <form action="{{ route('data-wali-kelas.update', $item->nip) }}" method="post" class="mt-3">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="nip">NIP</label><sup class="text-danger">(*)</sup>
                                <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror" id="nip" placeholder="NIP" value="{{ old('nip', $item->nip) }}" required>
                                @error('nip')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="d-flex justify-content-start mt-3">
                        <a href="{{ route('data-wali-kelas.index') }}" class="btn btn-secondary me-2">Kembali</a>
