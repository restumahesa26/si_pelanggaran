        ...
        <div class="card w-100">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="{{ route('keputusan-siswa.update', $item2->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="keputusan">Keputusan</label><sup class="text-danger">(*)</sup>
                                <input type="text" name="keputusan" class="form-control @error('keputusan') is-invalid @enderror" id="keputusan" placeholder="Keputusan" value="{{ old('keputusan', $item2->keputusan) }}" required>
                                @error('keputusan')
