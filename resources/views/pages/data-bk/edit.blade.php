...
@section('title', 'Data Guru BK - Ubah')
...
<div class="row">
    <div class="col-lg-12 d-flex align-items-strech">
        <div class="card w-100">
            <div class="card-body">
                <h5 class="card-title fw-semibold">Ubah Data Guru BK</h5>
                <form action="{{ route('data-bk.update', $item->nip) }}" method="post" class="mt-3">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="d-flex justify-content-start mt-3">
                        <a href="{{ route('data-bk.index') }}" class="btn btn-secondary me-2">Kembali</a>
