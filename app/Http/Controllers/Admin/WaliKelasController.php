...
class WaliKelasController extends Controller
{
    ...
    {
        $items = User::where('role', 'Wali Kelas')->orderBy('nama', 'ASC')->get();

        return view('pages.data-wali-kelas.index', compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Alert::toast('Berhasil Menambah Data Wali Kelas', 'success')->position('top');
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.data-wali-kelas.edit', compact('item'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        Alert::toast('Berhasil Mengubah Data Wali Kelas', 'success')->position('top');
        return redirect()->route('data-wali-kelas.index');
    }
    ...
    public function destroy(string $id)
    {
        ...
        Alert::toast('Berhasil Menghapus Data Wali Kelas', 'success')->position('top');
        return redirect()->route('data-wali-kelas.index');
    }
}
